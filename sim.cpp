...
ofstream coo_random("coord_random.csv");
ofstream coo_vivaldi("coord_vivaldi.csv");
...
void generate_virtual_coordinate() {
    ...
    for (int i = 0 ; i< n; i++) {
        auto f = (vivaldi_model[i]).local_coord.v ;
        coo_vivaldi << f.v[0] << ',' << f.v[1] << "\n" ;
    }
